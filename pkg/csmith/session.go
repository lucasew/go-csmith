...
//   - residual non-Sess duals: Variable duals, NewVariableSelector ambient
//     install, rSess/vsSess/… nil→ambient owner helpers
//   - CVQualifiers + statement_meta + Effect duals deleted (*Sess only)
