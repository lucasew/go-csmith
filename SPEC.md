...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **993** (898→991→993; seed2 full held). |

Next plateau: seed4 e993 U14 filter tries after Global U9; seeds 5–21; source; COUNT=20.
