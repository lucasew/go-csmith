...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~7323** (multi-dim CreateArray visit F0 multiphase + PP VS U1 re-itemize; next open re-itemize U9 vs F80 after VS miss)|
