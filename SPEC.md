...
**Explicitly still open (not closed by grill):** seed5 full event stream (living first_div ~7919); seeds 7–21 events; seed2/4 **source** match; stripping legacy residual/`silenceTrace` debt already in tree; full flag parity (§4 phase C). Work continues under the closed rules above.
...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~7919** (post-Break Assign Lhs after RHS PL create; UP F10 vs GO F80)|
...
4. Next: e7919 Lhs after RHS create — UP F10 vs GO F80.
