...
**Explicitly still open (not closed by grill):** seed5 full event stream (living first_div ~6442); seeds 7–21 events; seed2/4 **source** match; stripping legacy residual/`silenceTrace` debt already in tree; full flag parity (§4 phase C). Work continues under the closed rules above.
