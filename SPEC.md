...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~6810** (post-ArrayOp Assign SelectDeref NewArray *CreateArray alts U3; next open F0 vs Expression U120 after itemize)|
