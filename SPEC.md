...
| Seed 2 event match | **In progress** — `first_divergence_event` advanced **92 → 1437** (defaults) |
| Seed 2 source match | Blocked on event match |
| 20-seed gate | Not started |

Next plateau focus: e1437 U4 vs U2 after Lhs F80 SelectDeref (needNoRhs/choose).
