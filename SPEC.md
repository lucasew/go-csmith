...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~7201** (post-CreateArray SelectDeref multi-dim itemize residual → Global U17 PL F20 create; next open qfer F50 vs Expression U120)|
