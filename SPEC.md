...
| Seed 2 event match | **In progress** — `first_divergence_event` advanced **92 → 1097** (defaults) |
| Seed 2 source match | Blocked on event match |
| 20-seed gate | Not started |

Next plateau focus: e1097 second SelectDeref F80 vs GO F10 (ConstPointers) after Lhs ParentParam→stack create + first F80 create path.
