...
| Seed 2 event match | **In progress** — `first_divergence_event` advanced **92 → 1390** (defaults) |
| Seed 2 source match | Blocked on event match |
| 20-seed gate | Not started |

Next plateau focus: e1390 U28 vs U6 Global eFlexible after ParentLocal U2.
