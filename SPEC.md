...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **1042** (898→1038→1042; seed2 full held). |

Next plateau: seed4 e1042 F20 vs F50 after PL stack U3; seeds 5–21; source; COUNT=20.
