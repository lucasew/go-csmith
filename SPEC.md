...
| Seed 2 event match | **In progress** — `first_divergence_event` advanced **92 → 844** (defaults) |
| Seed 2 source match | Blocked on event match |
| 20-seed gate | Not started |

Next plateau focus: e844 SelectGlobal U2 (two matching pointer globals) vs GO create F50 — GlobalList inventory under-count for pointer types after e825 create.
