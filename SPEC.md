...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~7209** (post-CreateArray SelectDeref itemize → Global U17 PL F20 + Constant residual; next open U100 tries=1 VS filter)|
