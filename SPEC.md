...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~6317** (post-ArrayOp free Expression PL: matched stack U2 + eFlexible higher-indirection choose U2; UP next U7 vs GO F80 Lhs); seed7+ open |
