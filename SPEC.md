...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **1887** (1872→1883→1887; seed2 full held). |

Next plateau: seed4 e1887 F20 vs U2 after late Global (create residual); seeds 5–21; source; COUNT=20.
