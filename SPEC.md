...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **783** (629→645→688→754→772→783; seed2 full held). |

Next plateau: seed4 e783+ loop-body Assign; seeds 5–21; source; COUNT=20.
