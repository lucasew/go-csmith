...
| Struct types + decls | **Partial** |
| Layer 6c: create_field_vars + expand in select | **Partial** — .fN names, nested expand, parent const/vol OR |
| Real bitfields / unions / CFG back-edge | **Not started** |
| CLI drop-in | **Wired** |
