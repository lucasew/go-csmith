...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **629** (453→586→613→629; seed2 full held). |

Next plateau: seed4 e629 Statement U100 tries; seeds 5–21; source; COUNT=20.
