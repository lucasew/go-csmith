...
**Explicitly still open (not closed by grill):** seed5 full event stream (living first_div ~6337); seeds 7–21 events; seed2/4 **source** match; stripping legacy residual/`silenceTrace` debt already in tree; full flag parity (§4 phase C). Work continues under the closed rules above.
...
| Seeds 5,7–21 event | **FAIL** — seed5 first_div **~6337** (e6324: Lhs random_add F10 F50 after ExpressionVariable non-wildcard qfer; e6331 empty make_init choose no U); seed7+ open |
