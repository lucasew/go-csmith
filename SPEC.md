...
| Seed 2 event match | **PASS** — full **37939/37939** (held after seed4 climb →17733) |
| Seed 2 source match | **FAIL** — residual-driven path; not full Csmith-flow AST |
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **17733** (17495→17733; ptr-cmp bare Constant+U100, freePP/PL multiphase, ConstOnly hex8/small, free Global U138/U9 catalogs, useEx F0 nest + late PP; seed2 full held). Toward 18000+. |
