...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **~340** (re-climb after seed2 restore; was 629 with seed2 broken). |

Next plateau: re-climb seed4 with seed2-safe gates only; seeds 5–21; source; COUNT=20.
