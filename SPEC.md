...
| Seed 2 event match | **PASS** — full **37939/37939** (held after seed4 climb →36000) |
| Seed 2 source match | **FAIL** — residual-driven path; not full Csmith-flow AST |
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **36000** (31001→36000; SelectDeref free invent multiphase burn through ~35999 with U3/U8/U2 shape bodies, VS exits, depth-gap hex/pure_rnd, U14/U100/U120 tries filters; seed2 full held). Toward 40000+ / full ~106117. |
