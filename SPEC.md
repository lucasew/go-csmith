...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **428** (62→…→340→405→422→428); seed5 first_div **155**. |

Next plateau: seed4 e428 ParentLocal itemize depth; seed5 e155; multi-seed; residual→real; source; COUNT=20.
