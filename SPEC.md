...
| 20-seed gate | **In progress** — seed3 **PASS** 64/64; seed4 first_div **453** (340→…→405→422→433→449→453; seed2 full held). |

Next plateau: seed4 e453 F80 vs F50 SelectDeref continue; keep seed2 full; seeds 5–21; source; COUNT=20.
